...
test_build_request :: proc(t: ^testing.T) {
    tests := []struct{method: Method, url: Url, headers: map[string]string, body, res: string}{
        ...
        {.Get, {"https", "foo.com", "/", "", "", "https://foo.com/", 443}, {"Connection" = "close"}, "", "GET / HTTP/1.1\r\nHost: foo.com\r\nConnection: close\r\n\r\n"},
        {.Get, {"https", "foo.com", "/", "", "", "https://foo.com/", 443}, {"Connection" = ""}, "", "GET / HTTP/1.1\r\nHost: foo.com\r\nConnection: \r\n\r\n"},
...
test_parse_response :: proc(t: ^testing.T) {
    ...
    tests := []struct{buf: string, res: ^Response, err: Parse_Error}{
        {"HTTP/1.1 200 OK\r\nHost: foo.com\r\nConnection: close\r\n\r\n" + body, &{{"Host" = "foo.com", "Connection" = "close"}, "HTTP/1.1", "OK", transmute([]u8)body, 200}, .None},
        {"HTTP/1.1 200 OK\r\nHost: foo.com\r\nConnection: close\r\n\r\n", &{{"Host" = "foo.com", "Connection" = "close"}, "HTTP/1.1", "OK", {}, 200}, .None},
        {"HTTP/1.1 200 OK\r\nHost: foo.com\r\nConnection: \r\n\r\n", &{{"Host" = "foo.com", "Connection" = ""}, "HTTP/1.1", "OK", {}, 200}, .None},
